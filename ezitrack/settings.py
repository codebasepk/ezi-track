...
SECRET_KEY = 'django-insecure-&!oolqle#+4*&$*1n8te2ntk5^=82pd$z8%ic1!+9ui20*ko0f'
...
WSGI_APPLICATION = 'ezitrack.wsgi.application'
...
WHITENOISE_AUTOREFRESH = True  # Set this to False in production
...
JAZZMIN_SETTINGS: Dict[str, Any] = {
    ...
    "site_title": "EziTrack QMS",
    # Title on the brand, and login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "EziTrack QMS",
...
JAZZMIN_UI_TWEAKS = {
    ...
    "brand_colour": "navbar-brand-primary",
    ...
    "footer_fixed": False,
    "sidebar_fixed": False,
    "sidebar": "sidebar-dark-brand-primary",
